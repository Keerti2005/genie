...
const Rewards = () => {
  ...
  const rewards = [
    { 
      ...
      available: true,
      image: "🎁",
      description: "Use for any purchase at Walmart stores or online"
    },
    { 
      id: 2, 
      name: "20% Off Organic Produce", 
      points: 300, 
      category: "Discounts",
      available: true,
      image: "🥬",
      description: "Valid for one shopping trip on organic fruits & vegetables"
    },
    { 
      id: 3, 
      ...
      available: true,
      image: "🍴",
      description: "Sustainable bamboo utensils with carrying case"
    },
    { 
      id: 4, 
      ...
      available: true,
      image: "🔋",
      description: "10,000 mAh solar-powered portable charger"
    },
    { 
      id: 5, 
      name: "Free Eco-Delivery Month", 
      points: 400, 
      category: "Services",
      available: true,
      image: "🚚",
      description: "One month of free carbon-neutral delivery"
    },
    { 
      id: 6, 
      ...
      available: true,
      image: "💧",
      description: "Insulated stainless steel bottle with custom engraving"
    }
  ];
